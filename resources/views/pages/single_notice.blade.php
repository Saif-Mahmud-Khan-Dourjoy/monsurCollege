...
@section('main_content')
    <div class="single_notice">
        <div class="container">
            <div class="single_notice_top_div">
                <div class="single-notice-title">
                ...
                <div class="notice-divider-timing-div">
                    ...
                    <div class="single-notice-date-time-div">
                        <div>
                            10:15 AM
                        </div>
                        <div>
            ...
            <div class="notice-img-div">
                 <img src="{{asset('images/applicationimage.svg')}}" alt="" style="height: 100%;width:100%">
            </div>
        ...
        <div class="home-footer-div">
            <div class="container">
                <div class="long-footer single-notice-footer" style="margin-bottom: 100px">
