...
@section('main_content')
        ...
        <div class="container">
            <div class="hero-content-wrapper">
                ...
                <div class="hero-content">
                    <div style="height: 3px; width:100%;background:white;margin-top:50px;border-radius:10px"></div>
                    <div class="hero-title mt-4" style="">
                        Contact us for any query related to the college
                        <div class="mt-4"
                            style="height: 3px; width:100%;background:white;margin-bottom:50px;border-radius:10px"></div>
    ...
    <div class="container">
        <div class="contact-us-div row gy-3  justify-content-center" >
            <div class="col-lg-4 col-sm-8 col-12">
                <div class="contact-phone-div common-contact-main-div">
                    <div style="display:flex;justify-content:center">
                        <div style="height: 40px;width:40px;text-align:center;border-radius:50%;background:white">
                            <i style="line-height:40px" class="fa-solid fa-phone-volume"></i>
                        </div>

                    </div>
                    <div class="common-contact-title">
                        Phone number
                    </div>
                    <div class="common-contact-para">
                        01515287150
                    </div>
            ...
            <div class="col-lg-4 col-sm-8 col-12">
                <div class="contact-email-div common-contact-main-div">
                    
                    <div style="display:flex;justify-content:center">
                        <div style="height: 40px;width:40px;text-align:center;border-radius:50%;background:white">
                            <i style="line-height:40px" class="fa-solid fa-envelope"></i>
                        </div>
                    ...
                    <div class="common-contact-para" style="width: 100%">
                        monsurahmadmohillacollege@gmail.com
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-8 col-12">
                <div class="contact-location-div common-contact-main-div">
                    <div style="display:flex;justify-content:center">
                        <div style="height: 40px;width:40px;text-align:center;border-radius:50%;background:white">
                            <i style="line-height:40px" class="fa-solid fa-location-dot"></i>
                        </div>
        ...
        <div class="container">
            <div class="long-footer" style="margin-bottom: 100px">
                ...
                <div class="contact-form-div row">
                  ...
                  ">
                            <span style="padding: 3px 5px; background:#AF8F3F"><i class="fa-regular fa-envelope"></i></span>
                        ...
                        <div>
                            <form action="">
                                ...
                                <input placeholder="Guardians Name *" type="text"
                                    class="form-control contact-common-input" name="" id="">
                                <input placeholder="Phone Number *" type="text" class="form-control contact-common-input"
                                    name="" id="">
